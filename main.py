...
async def get_ibkr_price(symbol: str, expiry_str: str, opt_type: str, strike: float):
    """Get real-time option price from IBKR VPS — 24/7"""
    try:
...
async def track_price(app, trade_key):
    """Auto price tracking — IBKR 24/7, Polygon as fallback"""
...
# ============================================================
# TRADINGVIEW WEBHOOK — ينشر نص التنبيه مباشرة في القناة الخاصة
# ============================================================
async def handle_webhook(request):
    try:
        ...
        logger.info(f"TradingView alert sent to channel: {text[:60]}")
